...
> This document specifies the public graph schema used by the checked CSK Profile
...
Meaning Graph v0 is a structural contract for a future Lispex CSK Profile
...
Known v0 exclusions: `set!`, `values`, `guard`, `letrec`, variadic lambdas,
...
Topaz reporting, target-code generation, full Core Semantic Kernel coverage, or any private
